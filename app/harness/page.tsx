...
export const metadata: Metadata = {
  ...
  description: 'Inspect, test, and build GitHub projects in isolated Vercel Sandboxes with browser-local run history.',
      ...
      <main className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
        <div className="max-w-4xl">
          ...
          <p className="mt-4 text-lg leading-8 text-muted">
            Connect a public GitHub repository, run a bounded inspection, test, or build inside Vercel Sandbox, and keep the latest results locally in your browser—no database required.
          </p>
          <div className="mt-5 flex flex-wrap gap-2 font-mono text-xs text-muted">
            ...
            <span className="rounded-full border border-line px-3 py-1.5">Private access key</span>
